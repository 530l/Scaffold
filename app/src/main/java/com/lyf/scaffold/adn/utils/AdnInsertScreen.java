...
//新插屏广告
public class AdnInsertScreen {
    private final String TAG = "InsertScreen";
    @SuppressLint("StaticFieldLeak")
    private static AdnInsertScreen _Instance;

    public static AdnInsertScreen Inst() {
        if (_Instance == null) {
            _Instance = new AdnInsertScreen();
        }
        return _Instance;
    }
    ...
    private void loadAd(String codeId, int orientation) {
        ...
        mTTAdNative.loadFullScreenVideoAd(adSlot, new TTAdNative.FullScreenVideoAdListener() {
            ...
            public void onError(int code, String message) {
                ...
                AdnToast.show(mContext, message);
            }
            ...
            public void onFullScreenVideoAdLoad(TTFullScreenVideoAd ad) {
                ...
                AdnToast.show(mContext, "FullVideoAd loaded  广告类型：" + getAdType(ad.getFullVideoAdType()));
                mttFullVideoAd = ad;
                mIsLoaded = false;
                ...
                mttFullVideoAd.setFullScreenVideoAdInteractionListener(new TTFullScreenVideoAd.FullScreenVideoAdInteractionListener() {
                    ...
                    public void onAdShow() {
                        ...
                        AdnToast.show(mContext, "FullVideoAd show");
                    }

                    @Override
                    public void onAdVideoBarClick() {
                        Log.d(TAG, "Callback --> FullVideoAd bar click");
                        AdnToast.show(mContext, "FullVideoAd bar click");
                    }

                    @Override
                    public void onAdClose() {
                        Log.d(TAG, "Callback --> FullVideoAd close");
                        AdnToast.show(mContext, "FullVideoAd close");
                    }

                    @Override
                    public void onVideoComplete() {
                        Log.d(TAG, "Callback --> FullVideoAd complete");
                        AdnToast.show(mContext, "FullVideoAd complete");
                    }

                    @Override
                    public void onSkippedVideo() {
                        Log.d(TAG, "Callback --> FullVideoAd skipped");
                        AdnToast.show(mContext, "FullVideoAd skipped");
                ...
                ad.setDownloadListener(new TTAppDownloadListener() {
                    ...
                    public void onDownloadActive(long totalBytes, long currBytes, String fileName, String appName) {
                        ...
                        if (!mHasShowDownloadActive) {
                            ...
                            AdnToast.show(mContext, "下载中，点击下载区域暂停", Toast.LENGTH_LONG);
                        }
                    }
                    ...
                    public void onDownloadPaused(long totalBytes, long currBytes, String fileName, String appName) {
                        ...
                        AdnToast.show(mContext, "下载暂停，点击下载区域继续", Toast.LENGTH_LONG);
                    }

                    @Override
                    public void onDownloadFailed(long totalBytes, long currBytes, String fileName, String appName) {
                        Log.d("DML", "onDownloadFailed==totalBytes=" + totalBytes + ",currBytes=" + currBytes + ",fileName=" + fileName + ",appName=" + appName);
                        AdnToast.show(mContext, "下载失败，点击下载区域重新下载", Toast.LENGTH_LONG);
                    }

                    @Override
                    public void onDownloadFinished(long totalBytes, String fileName, String appName) {
                        Log.d("DML", "onDownloadFinished==totalBytes=" + totalBytes + ",fileName=" + fileName + ",appName=" + appName);
                        AdnToast.show(mContext, "下载完成，点击下载区域重新下载", Toast.LENGTH_LONG);
                    }

                    @Override
                    public void onInstalled(String fileName, String appName) {
                        Log.d("DML", "onInstalled==" + ",fileName=" + fileName + ",appName=" + appName);
                        AdnToast.show(mContext, "安装完成，点击下载区域打开", Toast.LENGTH_LONG);
                    }
                });
            }
            ...
            public void onFullScreenVideoCached() {
                ...
                AdnToast.show(mContext, "onFullScreenVideoCached");
            }
            ...
            public void onFullScreenVideoCached(TTFullScreenVideoAd ad) {
                ...
                mIsLoaded = true;
                AdnToast.show(mContext, "FullVideoAd video cached");
