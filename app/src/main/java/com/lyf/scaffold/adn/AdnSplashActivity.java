...
import com.lyf.scaffold.adn.utils.AdnUIUtils;


@SuppressLint("CustomSplashScreen")
public class AdnSplashActivity extends Activity {
    ...
    private String mCodeId = "887958726";//开屏广告代码位id
    private boolean mIsExpress = false; //是否请求模板广告
    private boolean mIsHalfSize = false;
    private static AdnSplashActivity _Instance;

    public static AdnSplashActivity Inst() {
        return _Instance;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTTAdNative = TTAdManagerHolder.getTTAdManager().createAdNative(this);
    ...
    public void loadSplashAd() {
        AdSlot adSlot = null;
        float splashWidthDp = AdnUIUtils.getScreenWidthDp(this);
        int splashWidthPx = AdnUIUtils.getScreenWidthInPx(this);
        int screenHeightPx = AdnUIUtils.getScreenHeight(this);
        float screenHeightDp = AdnUIUtils.px2dip(this, screenHeightPx);
...
//            float expressViewHeight = UIUtils.getHeight(this);
        ...
        mTTAdNative.loadSplashAd(adSlot, new TTAdNative.SplashAdListener() {
            ...
            public void onSplashAdLoad(com.bytedance.sdk.openadsdk.TTSplashAd ad) {
                ...
                if (view != null && mSplashContainer != null && !AdnSplashActivity.this.isFinishing()) {
...
//                    ad.setNotAllowSdkCountdown();
    ...
    private void goToMainActivity() {
        Intent intent = new Intent(AdnSplashActivity.this, AdnMainActivity.class);
