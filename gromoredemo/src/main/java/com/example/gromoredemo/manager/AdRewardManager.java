package com.example.gromoredemo.manager;
...
public class AdRewardManager {
    ...
    private void loadAd(String adUnitId, int orientation) {
        ...
        // 会透传给媒体的服务器
        customData.put(GMAdConstant.CUSTOM_DATA_KEY_GROMORE_EXTRA, "gromore serverside verify extra data");
    ...
    public void printSHowAdInfo() {
        ...
        String s = "展示的广告信息 ：代码位id = " + gmAdEcpmInfo.getAdNetworkRitId() +
                "adnName = " + gmAdEcpmInfo.getAdnName() + " ecpm = " + gmAdEcpmInfo.getPreEcpm();
        Logger.e(TAG, s);
    }
